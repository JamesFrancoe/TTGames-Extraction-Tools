...
namespace ExtractDx11MESH
{
  public class ExtractDx11MESH
  {
    ...
    public void ParseArgs(string[] args)
    {
      ...
      ExtractDx11MESH.ExtractDx11MESH.directoryname = File.Exists(args[0]) ? Path.GetDirectoryName(args[0]) : throw new ArgumentException(string.Format("File {0} does not exist!", (object) args[0]));
      this.extention = Path.GetExtension(args[0]);
      this.filename = Path.GetFileName(args[0]);
      ExtractDx11MESH.ExtractDx11MESH.filenamewithoutextension = Path.GetFileNameWithoutExtension(args[0]);
    ...
    public void Extract()
    {
      ...
      ExtractDx11MESH.ExtractDx11MESH.directoryname = fileInfo.DirectoryName;
    ...
    private void readMESH()
    {
      ...
      if (this.fileData[this.iPos] == (byte) 72 && this.fileData[this.iPos + 1] == (byte) 83 && this.fileData[this.iPos + 2] == (byte) 69 && this.fileData[this.iPos + 3] == (byte) 77)
      {
        ...
        {
          flag = false;
          ExtractDx11MESH.ExtractDx11MESH.CreateObjFile(this.mesh, part, num++);
        }
      }
      else
    ...
    public static void CreateObjFile(MESH04 mesh, Part part, int partnumber)
    {
      ...
      StreamWriter streamWriter1 = new StreamWriter(ExtractDx11MESH.ExtractDx11MESH.directoryname + "\\" + ExtractDx11MESH.ExtractDx11MESH.filenamewithoutextension + string.Format("{0:0000}", (object) partnumber) + ".obj");
      streamWriter1.WriteLine("# " + ExtractDx11MESH.ExtractDx11MESH.filenamewithoutextension);
      if (vertexList2.Vertices[0].Position != null)
      {
        for (int offsetVertices = part.OffsetVertices; offsetVertices < part.OffsetVertices + part.NumberVertices; ++offsetVertices)
        {
      ...
      streamWriter1.WriteLine("mtllib " + ExtractDx11MESH.ExtractDx11MESH.filenamewithoutextension + string.Format("{0:0000}", (object) partnumber) + ".mtl");
      StreamWriter streamWriter2 = new StreamWriter(ExtractDx11MESH.ExtractDx11MESH.directoryname + "\\" + ExtractDx11MESH.ExtractDx11MESH.filenamewithoutextension + string.Format("{0:0000}", (object) partnumber) + ".mtl");
